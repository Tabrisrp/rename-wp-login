	...
	class WPS_Hide_Login {
		...
		public function whl_section_desc() {
			...
			if ( ! is_multisite()
				...
				$out .= '<a href="' . $details_url_wpsbidouille .'" class="thickbox open-plugin-details-modal">' . __( 'WPS Bidouille', 'wpserveur-hide-login' ) . '</a>';
				$out .= ', <a href="' . $details_url_wpslimitlogin .'" class="thickbox open-plugin-details-modal">' . __( 'WPS Limit Login', 'wpserveur-hide-login' ) . '</a>';
				$out .= '</div>';
